        ...
        <form role="form" method="post" action="{{ route('products.update', ['product' => $product->id]) }}" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-ms-6">
                        <div class="form-group">
                                <input type="checkbox" name="status" class="form-control" @if($product->status) checked @endif>
                ...
                <div class="row">
                    <div class="col-ms-6">
                        <div class="form-group">
                                <input type="checkbox" name="bestseller" class="form-control" @if($product->bestseller) checked @endif>
